            ...
            <div class="overlay">
                <div class="container">
                    <div class="col-md-10 col-md-offset-1 text-center">
                        ...
                        <!-- /.logo -->
                        <div class="logo wow fadeInDown" style="margin-top: 50px"> <a href=""><img src="images/Qisimah-logo-white-small-cropped.png" alt="logo"></a></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <div class="btn-section"><a href="index.html" class="btn-default">Return</a></div>
        ...
        <footer id="footer">
            <div class="container">
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="text-center wow fadeInUp">Copyright Qisimah 2017 </div>
