    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="widget no-border">
                <table id="daily-plays" style="width: 100%" class="table table-hover dt-responsive nowrap">
                    <thead>
                        <tr>
                            <th style="width:20%" class="text-center">Title</th>
                            <th style="width:20%" class="text-center">Artist</th>
                            <th style="width:15%" class="text-center">Broadcaster</th>
                            <th style="width:10%" class="text-center">Played</th>
                        </tr>
                    </thead>
                    <tbody>
