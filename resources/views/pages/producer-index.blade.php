            ...
            <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">
                <div class="widget">
                    <div class="widget-heading">
                        <h3 class="widget-title">add new producer</h3>
                    </div>
                    <div class="widget-body">
                        <form class="" method="post" action="{{route('producer.store')}}">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div role="group" aria-label="Basic example" class="btn-group btn-group-sm col-xs-12">
                                            <a class="btn btn-outline btn-success edit-genre col-xs-6" data-content="{{$producer->q_id}}"><i class="ti-pencil"></i></a>
                                            <a class="btn btn-outline btn-danger delete-genre col-xs-6" data-content="{{$producer->q_id}}" data-name="{{$producer->nick_name}}"><i class="ti-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
