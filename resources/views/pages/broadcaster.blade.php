    ...
    <div id="frmBroadcaster" tabindex="-1" role="dialog" aria-labelledby="modalWithForm" class="modal fade">
        <div role="document" class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="/file/create/song" method="post" id="frmSaveBroadcaster" class="form-horizontal" onsubmit="">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input id="txtBroadcasterName" name="txtBroadcasterName" type="text" class="form-control" placeholder="broadcaster name" minlength="3" maxlength="20" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="txtFrequency" name="txtFrequency" class="form-control" placeholder="123.45" minlength="4" maxlength="6" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="selCountry" id="selCountry" class="form-control chosen-select" size="8" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="selRegion" id="selRegion" class="form-control chosen-select" size="8" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="txtCity" class="form-control" minlength="2" maxlength="30" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="txtAddress" class="form-control" minlength="5" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="tel" id="txtPhone" class="form-control" placeholder="Telephone..." minlength="10">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" id="txtStreamId" class="form-control" placeholder="Stream ID..." minlength="5">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="selTags" id="selTags" class="form-control chosen-select" multiple required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        <input id="txtTagLine" name="txtTagLine" type="text" class="form-control" placeholder="tag line..." minlength="5">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group has-feedback">
                                    ...
                                    <div id="dvUploadLogo" data-img-url="" data-storage-id="" class="col-sm-12">
                                        <input id="txtLogo" name="txtLogo" type="file" class="form-control filestyle" data-buttonText="Select Logo" data-buttonName="btn btn-black btn-outline" data-placeholder="no image selected">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btnSaveBroadcaster" type="submit" class="btn btn-black" data-record-id="">Save</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="page-content container-fluid">
        ...
        <div class="widget">
            <div class="widget-body table-responsive">
                <table id="broadcasters" class="table table-responsive table-hover table-striped table-bordered table-condensed">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach($listen as $broadcaster)
                            <tr>
                                ...
                                <td class="text-center">{{$broadcaster['city']}}, {{$broadcaster['country_id']}}</td>
