<aside class="main-sidebar">
    ...
    <div class="user">
        ...
        <div id="divProPic" data-percent="65" style="height: 130px; width: 130px; line-height: 100px; padding: 15px;"
             class="easy-pie-chart">

            <a href="#" onclick="$('#txtProPic').click();">

                <img id="imgProPic" src="{{($user['img'])? $user['img'] : asset('images/users/avatar.png')}}" alt=""
        ...
        <li class="panel">
            ...
            <ul id="collapse1" class="list-unstyled {{( ( \Illuminate\Support\Facades\Request::is('file/create/ad') || \Illuminate\Support\Facades\Request::is('file/create/song') ) ? "active" : "collapse" )}}">
                @if($user['type'] === 'admin')
                    ...
                    <li><a href="{{url('file/create/song')}}" class="{{( \Illuminate\Support\Facades\Request::is('file/create/song')? "active" : "" )}}">Upload song</a></li>
                @elseif($user['type'] === 'advertiser')
                    <li><a href="{{url('file/create/ad')}}" class="{{( \Illuminate\Support\Facades\Request::is('file/create/ad')? "active" : "" )}}">Upload ad</a></li>
                @elseif($user['type'] === 'artist' || $user['type'] === 'record-label')
                    <li><a href="{{url('file/create/song')}}" class="class="{{( \Illuminate\Support\Facades\Request::is('file/create/song')? "active" : "" )}}"">Upload song</a></li>
                @endif
            </ul>
        </li>
        @if($user['type'] === 'admin')
