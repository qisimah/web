...
<script type="text/javascript">
   ...
   $(document).ready( function updateTimer() {
        ...
        document.getElementById("timer")
            .innerHTML =
            '<div style="display: inline-block; padding-bottom: 10px; margin-top: 0%; min-width: 100%; background: #1f364f;">' + d + '<br><span style="color: #B1CDF1; display: block; font-size: .45em; font-weight: 400;">Days Left</span></div>';
