...
@section('form')
    ...
    <form action="{{ route('albums.store') }}" class="row" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            ...
            <div class="col-xs-12 col-lg-6 form-group">
                ...
                <input type="text" class="form-control" name="album-title" id="album-title" placeholder="title..."
                       required value="{{ old('album-title') ?? '' }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-lg-6 form-group">
                ...
                <input type="text" class="form-control" name="album-release-date" id="album-release-date"
                       placeholder="YYYY-MM-DD" value="{{ old('album-release-date') ?? '' }}" required>
            </div>
